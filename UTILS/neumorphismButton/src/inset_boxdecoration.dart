...
import './inset_boxshadow.dart';

class CustomBoxDecoration extends painting.BoxDecoration {
  const CustomBoxDecoration({
    Color? color,
    DecorationImage? image,
    BoxBorder? border,
    BorderRadiusGeometry? borderRadius,
    List<BoxShadows>? boxShadow,
    Gradient? gradient,
  ...
  CustomBoxDecoration copyWith({
    ...
    assert(boxShadow is List<BoxShadows>?);
    ...
    return CustomBoxDecoration(
      ...
      boxShadow: (boxShadow ?? this.boxShadow) as List<BoxShadows>?,
  ...
  CustomBoxDecoration scale(double factor) {
    return CustomBoxDecoration(
      ...
      boxShadow: BoxShadows.lerpList(null, boxShadow as List<BoxShadows>, factor),
  ...
  CustomBoxDecoration? lerpFrom(Decoration? a, double t) {
    ...
    return super.lerpFrom(a, t) as CustomBoxDecoration?;
  }
  ...
  CustomBoxDecoration? lerpTo(Decoration? b, double t) {
    ...
    return super.lerpTo(b, t) as CustomBoxDecoration?;
  }
  ...
  static CustomBoxDecoration? lerp(CustomBoxDecoration? a, CustomBoxDecoration? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    if (a == null) {
    ...
    return CustomBoxDecoration(
      ...
      boxShadow: BoxShadows.lerpList(
        a.boxShadow as List<BoxShadows>,
        b.boxShadow as List<BoxShadows>,
        t,
      ),
...
class _InsetBoxDecorationPainter extends BoxPainter {
  ...
  void _paintInnerShadows(
    ...
    for (final painting.BoxShadow boxShadow in _decoration.boxShadow!) {
      if (boxShadow is! BoxShadows || !boxShadow.inset) {
        continue;
      }
...
Rect _areaCastingShadowInHole(Rect holeRect, BoxShadows shadow) {
  var bounds = holeRect;
